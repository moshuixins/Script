...
import com.moshuixin.memory.IRootIPC;
...
public abstract class RootIPCReceiver<T> {
    private static final String TAG = RootIPCReceiver.class.getName();
     ...
     */
    public abstract void onConnect(@NotNull T ipc);
     ...
     * @param ipc The Binder interface you declared in an aidl and passed to RootIPC on the root side
     */
    public abstract void onDisconnect(@NotNull T ipc);

    static final String BROADCAST_ACTION = "com.moshuixin.process.RootIPCReceiver.BROADCAST";
    static final String BROADCAST_EXTRA = "com.moshuixin.process.RootIPCReceiver.BROADCAST.EXTRA";
    ...
    public void setContext(Context context) {
        ...
        if (context != null) {
            ...
            Log.e(TAG, "setContext: " + context);
            Log.e(TAG, "setContext: " + receiver);
    ...
    private T getInterfaceFromBinder(IBinder binder) {
        return (new InterfaceRetriever<T>()).getInterfaceFromBinder(clazz, binder);
    }
