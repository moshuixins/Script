...
import com.moshuixin.proces.servlet.reflection.ServiceManager;
...
public class RootIPC {
    private static final String TAG = RootIPC.class.getName();
    ...
    public void broadcastIPC() {
        ...
        //ServiceManagerS.sendBroadcast(intent);
