...
import com.moshuixin.proces.servlet.reflection.Other;
...
public class LaunchScript {
    ...
    private static String getLaunchString(String packageCodePath, String clazz, String app_process, boolean is64Bit, String[] params, String niceName) {
        ...
        if (Other.isVmDebugEnabled()) { // we don't use isEnabled() because that has a different meaning when called as root, and though rare we might call this method from root too
